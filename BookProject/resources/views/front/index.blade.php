...
<!--bottom-header-->
	...
	<!--banner-ends--> 
	<!--Slider-Starts-Here-->
				<script src="{{asset('front_css/js/responsiveslides.min.js')}}"></script>
			 <script>
                        ...
                        @foreach($chunk as $key=>$value)
                            <div class="col-md-3 product-left">
                                <div class="product-main simpleCart_shelfItem">
                                    <a href="{{route('kitap.detay',['selflink'=>$value['selflink']])}}" class="mask"><img style="widt:200px;height:200px" class="img-responsive zoom-img" src="{{asset($value['image'])}}" alt="" /></a>
