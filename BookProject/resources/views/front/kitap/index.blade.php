			...
			<div class="single-main">
				...
				<div class="sngl-top">
					<div class="col-md-4 single-top-left">	
						...
						<!-- FlexSlider -->
						<script src="{{asset('front_css/js/imagezoom.js')}}"></script>
						<script defer src="{{asset('front_css/js/jquery.flexslider.js')}}"></script>
						<link rel="stylesheet" href="{{asset('front_css/css/flexslider.css')}}" type="text/css" media="screen" />
